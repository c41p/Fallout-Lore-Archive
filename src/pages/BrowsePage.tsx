...
export function BrowsePage() {
  ...
  return <div className="page"><header className="page-header"><span className="kicker">GLOBAL INDEX</span><h1>Search & browse</h1><p>Search canonical names, aliases, summaries, article sections and tags.</p></header>
