...
- The archive contains 2,354 canonical records and broad released-game coverage, but it is not an exhaustive franchise corpus. The completion manifest explicitly excludes 14,717 mechanical, reference-only, unreleased or low-value long-tail candidates.
...
- Most broad-franchise profiles currently use revision-attributed community references. This is an intentional baseline, not a statement of official canon authority. Claim-level released-game locators remain strongest in the Fallout 1/Maxson clusters and are the principal future evidence-deepening backlog.
